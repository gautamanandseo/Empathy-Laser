...
const BlogAddForm = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({
        title: '', slug: '', content: '', image_url: '', author: 'Dr. Expert', 
        date: new Date().toISOString().split('T')[0]
      });
      onSuccess();
      onClose();
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Blog Post" className="max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <input 
                ...
                placeholder="e.g. laser-hair-removal-tips"
            />
          </div>
          <div className="space-y-2">
